...
import com.sismics.music.core.dao.dbi.dto.MusicDto;
...
public class ArtistResource extends BaseResource {
    ...
    public Response list(
        ...
        PaginatedList<MusicDto> paginatedList = PaginatedLists.create(limit, offset);
        ...
        for (MusicDto artist : paginatedList.getResultList()) {
